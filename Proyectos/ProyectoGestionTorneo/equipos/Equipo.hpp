...
public:
    ...
    //Getters (Todos llevan 'const' porque no modifican la clase, solo leen)
    int getId() const;
    ...
    //Setters (Retornan bool para indicar si la validación fue exitosa o falló)
    ...
    //Métodos de Negocio (Abstracción y Responsabilidad Única)
    ...
    //Método estático requerido por el profesor
